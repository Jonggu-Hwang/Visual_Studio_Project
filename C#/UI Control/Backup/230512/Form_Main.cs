...
namespace TM_UI
{
    public partial class Form_Main : Form
    {
        ...
        private void ui_imageBox_Result_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            //else if (TemplateMatching.Properties.Settings.Default.radioMultiple == true)
            //{
            //    Rectangle[] rectangles = new Rectangle[Form_Parameter.multiple_Count];

            //    for (int i = 0; i <= Form_Parameter.multiple_Count - 1; i++)
            //    {
            //        rectangles[i] = new Rectangle(tuple_Multiple_arr_Public[i].Item3.X, tuple_Multiple_arr_Public[i].Item3.Y, Template_Image_Mat.Width, Template_Image_Mat.Height);
