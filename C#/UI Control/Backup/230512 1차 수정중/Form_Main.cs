...
namespace TM_UI
{
    public partial class Form_Main : Form
    {
        ...
        public double similarity_Public;
        public (int, double, OpenCvSharp.Point)[] tuple_Multiple_arr_Public;
        private bool isOriginalImageOpen = false;
        private bool isTemplateImageOpen = false;
        Form_Parameter parameter_dlg;
        public double single_Thr;
        public int multiple_Count;
        Matching matchT;

        public Form_Main(Matching matching)
        {
            InitializeComponent();
            matchT = matching;
        }
        ...
        private void ui_MatchingBtn_Click(object sender, EventArgs e)
        {
            ...
            parameter_dlg = new Form_Parameter(this);
            ...
            if (ui_imageBox_Og.Image != null && ui_imageBox_Temp.Image != null)
            {
                ...
                {
                    single_Thr = parameter_dlg.single_Thr;
                    ...
                    if (similarity >= parameter_dlg.single_Thr)
                    {
                ...
                {
                    multiple_Count = parameter_dlg.multiple_Count;
                    ...
                    tuple_Multiple_arr_Public = new (int, double, OpenCvSharp.Point)[parameter_dlg.multiple_Count];
                    tuple_Multiple_arr_Public = tuple_Multiple_arr;

                    // listView에 Data 입력
                    ui_listView.Items.Clear();
                    for (int i = 1; i <= parameter_dlg.multiple_Count; i++)
                    {
        ...
        public void ui_ParameterBtn_Click(object sender, EventArgs e)
        {
            parameter_dlg = new Form_Parameter(this);
            parameter_dlg.ShowDialog(this);
        }
        ...
        private void ui_imageBox_Result_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            else
            {
                ...
                tuple_Multiple_arr_Public = new (int, double, OpenCvSharp.Point)[parameter_dlg.multiple_Count];
                for (int rectIndex = 0; rectIndex < parameter_dlg.multiple_Count; ++rectIndex)
                {
